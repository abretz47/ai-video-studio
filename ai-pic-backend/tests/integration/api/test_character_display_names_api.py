...
def test_story_character_response_includes_virtual_ip_display_name(
 ...
 story = StoryFactory()
 virtual_ip = VirtualIPFactory(name="Lin Wan Mu Ban")
 StoryCharacterFactory(
 story=story,
 ...
 assert character["virtual_ip_name"] == "Lin Wan Mu Ban"
 assert character["name"] == "Lin Wan Mu Ban"
 assert character["display_name"] == "Lin Wan Mu Ban"
