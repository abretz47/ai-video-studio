...
def _create_story_episode_script(db_session, user: User, *, with_timeline: bool):
 story = Story(
 title="Ni Guang Zhi Xia",
 genre="urban",
 synopsis="She Ying Shi Juan Ru Shang Ye Yin Mou.",
 user_id=user.id,
)
 episode = Episode(
 story=story,
 episode_number=6,
 title="Zhen Xiang Bi Jin",
 summary="key evidence Fu Chu Shui Mian.",
)
 script = Script(
 episode=episode,
 title="Di6Ji Ju Ben",
 content="Lin Shen: Bu Shi you Xiang De Na Yang.",
 ...
 "start_ms": 78800,
 "end_ms": 80780,
 "dialogue_excerpt": "Bu Shi you Xiang De Na Yang.",
 }
 ],
 }
 }
...
def test_workbench_summary_ignores_stale_audio_timeline_metadata(
 ...
 """Jiu episode.extra_metadata.audio_timeline Bu Zai Rang timeline_ready Wei Zhen."""
 user = _admin_user(db_session)
