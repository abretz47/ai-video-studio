...
def _storyboard_frames() -> list[dict]:
 ...
 {
 "scene_number": 1,
 "description": "Lin Mei Zai Gong Xiang Ban Gong Qu Tiao Shi Zhi Neng Yin Xiang",
 ...
 "ai_prompt": "Cheng Xu Yuan Cuo E Di Kan Xiang Hui Shuo Hua De Zhi Neng Yin Xiang",
...
def test_production_canvas_execute_image_skill_dispatches_existing_task(
 ...
 json={
 "prompt": "generate Xian You storyboard De Tu Pian Hou Xuan",
...
def test_production_canvas_execute_video_skill_dispatches_existing_task(
 ...
 "/api/v1/production-canvas/execute",
 json={
 "prompt": "generate Xian You storyboard De video Hou Xuan",
...
def test_production_canvas_execute_report_skill_summarizes_existing_task(
 ...
 "/api/v1/production-canvas/execute",
 json={
 "prompt": "Hui Zong Zhe Ci Hua Bu Zhi Xing evidence",
