...
class TestInfoGateIntegration:
 ...
 # Register revealed info - only revealed to audience, not to John Doe
 validator.register_revealed_info(
 [
 RevealedInfoItem(
 info_key="villain_identity",
 info_content="Jane Roe Shi Mu Hou mastermind",
 revealed_to=["audience"], # Only revealed to audience
 ...
 dialogue = "Wo Zao Jiu Zhi Dao Jane Roe Shi Mu Hou mastermind Le!"
 ...
 # Should detect violation - John Doe shouldn't know this
 ...
 info_content="Bao Zang Zai Shan Dong Li",
 revealed_to=["John Doe", "audience"], # Revealed to John Doe
 revealed_at_episode=1,
)
 ]
)
 ...
 dialogue = "Bao Zang Ying Gai Jiu Zai Na Ge Shan Dong Li."
 results = validator.validate_dialogue(
 speaker="John Doe",
 dialogue_text=dialogue,
 context=context,
...
class TestSceneTransitionIntegration:
 ...
 {
 "scene_number": 2,
 "location": "Shang Hai", # 1000km away!
 "time_of_day": "morning", # Same time, no travel time
 "characters": ["John Doe"], # Same character
 },
 ]
 ...
 {
 "scene_number": 2,
 "location": "conference room", # Same building, reasonable
 "time_of_day": "morning",
 "characters": ["John Doe"],
 },
 ]
