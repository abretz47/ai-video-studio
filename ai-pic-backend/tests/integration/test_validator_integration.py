...
class TestInfoGateIntegration:
    ...
    def test_validator_detects_unrevealed_info_usage(self):
        ...
        validator.register_revealed_info(
            [
                RevealedInfoItem(
                    ...
                    info_content="Jane Roe is Mu Hou mastermind",
        ...
        dialogue = "Wo Zao Jiu Zhi Dao Jane Roe is Mu Hou mastermind！"
    ...
    def test_validator_passes_revealed_info(self):
        ...
        validator.register_revealed_info(
            [
                RevealedInfoItem(
                    ...
                    info_content="Bao Zang in Shan Dong Li",
        ...
        dialogue = "Bao Zang Ying Gai Jiu in Na Ge Shan Dong Li。"
        results = validator.validate_dialogue(
            speaker="John Doe",
            dialogue_text=dialogue,
            context=context,
