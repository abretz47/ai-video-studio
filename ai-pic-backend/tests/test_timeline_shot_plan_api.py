...
def test_timeline_shot_plan_api_updates_timeline_with_stable_clip_ids(
 ...
 assert shot_plan["direction_anchor"] == "Chao Xiang lonely Qing Dao Fu discover Xian Suo De Leng You Mo camera"
 ...
 assert "time Xian Xian Zou" in fake_ai.calls[0]["prompt"]
...
def test_timeline_shot_plan_prompt_includes_character_anchor_hint():
 ...
 video_clip["source_refs"]["character_name"] = "Xiaolan"
 video_clip["source_refs"]["character_appearance_prompt"] = "Yuan Run Lan Se robot"
