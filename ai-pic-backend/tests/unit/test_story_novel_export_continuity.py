...
def test_extract_chapter_markers_strips_leading_marker_block():
 ...
 assert cliffhanger == "Xian Gei Ka Dian"


def test_ensure_markers_appends_missing_markers():
 body = "Zheng Wen"
 merged = ensure_markers(
 body, summary_text="- Yao Dian 1\n- Yao Dian 2", cliffhanger_text="Gou Zi Ju Zi"
)

 assert "【chapter summary】" in merged
 assert "【chapter cliffhanger】" in merged
...
def test_normalize_ledger_update_payload_compacts_ledger_when_present():
 ...
 "chapter_summary": "Fa Sheng Liao Shi",
 "chapter_cliffhanger": "",
 }
 ledger, summary_text, cliffhanger = normalize_ledger_update_payload(payload)
...
def test_story_novel_zhihu_prompts_render_with_new_variables():
 base_payload = {
 "story": {"title": "Ce Shi Gu Shi", "genre": "drama"},
 ...
 "cliffhanger_hint": "Ka Dian Ti Shi",
 },
 "running_summary": "",
 ...
 "story_novel_zhihu_chapter_rewrite", {**base_payload, "draft": "Cao Gao Nei Rong"}
)
