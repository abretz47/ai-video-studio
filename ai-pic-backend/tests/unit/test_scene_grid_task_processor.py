...
def test_scene_grid_sheet_task_persists_grid(db_session, monkeypatch):
 ...
 "storyboard": {
 "frames": [
 {"scene_number": 1, "description": "Zui Bu Ru Chang", "duration_seconds": 1.0},
 {"scene_number": 1, "description": "Yang Tou He Jiu", "duration_seconds": 0.9},
 {"scene_number": 2, "description": "Qi Ta Chang Jing"},
 ]
 }
 },
)
 ...
 assert "【Zheng Ti Ban Shi】" in captured["prompt"]
...
def test_scene_grid_video_task_persists_video(db_session, monkeypatch):
 ...
 user = UserFactory()
 script = ScriptFactory(
 scenes=[{"scene_number": 1, "location": "outside the tavern"}],
 extra_metadata={
 "storyboard": {
 "frames": [],
 "scene_grids": {
 ...
 "aspect_ratio": "16:9",
 "cells": [
 {"panel_index": 1, "title": "Zui Bu Ru Chang", "caption": "Zui Bu Ru Chang", "duration": 6.0},
 {"panel_index": 2, "title": "Zhong Quan Hong Chen", "caption": "Zhong Quan Hong Chen", "duration": 6.0},
 ],
 }
 },
 }
 ...
 assert "Bu De Chu Xian storyboard Ge Zi" in captured["prompt"]
...
def test_scene_grid_video_task_fails_without_sheet(db_session, monkeypatch):
 ...
 assert "Shang Wei generate Gong Ge storyboard image" in refreshed_task.error_message
