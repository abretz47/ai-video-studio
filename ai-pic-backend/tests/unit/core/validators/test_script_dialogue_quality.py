...
def test_looks_like_writer_note_detects_meta_instruction():
 assert looks_like_writer_note("Ming Bai, Zhe Li Ke Yi Tu Chu conflict Huo emotion.") is True
...
def test_looks_like_writer_note_allows_in_world_suggestion():
 assert looks_like_writer_note("Wo Jian Yi you Xian Zai Jiu Zou.") is False


def test_find_reused_short_dialogues_flags_cross_scene_duplicates():
 dialogues = [
 {"scene_number": 1, "character": "Old Guai", "content": "Deng Yi Xia......Rang Wo Zai confirm Yi Xia."},
 {"scene_number": 2, "character": "Old Guai", "content": "Deng Yi Xia......Rang Wo Zai confirm Yi Xia."},
 {"scene_number": 1, "character": "A Gai Er", "content": "Ming Bai, Wo Men Ji Xu."},
 {"scene_number": 3, "character": "A Gai Er", "content": "Ming Bai, Wo Men Ji Xu."},
 ]
...
def test_validate_scene_dialogues_reports_quality_issues():
 ...
 "scene_number": 1,
 "character": "A Gai Er",
 "content": "Ming Bai, Zhe Li Ke Yi Tu Chu conflict Huo emotion.",
 },
 ]
