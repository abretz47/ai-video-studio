    ...
    beats_by_scene = {
        ...
        2: [
            SceneBeat(
                ...
                order_index=1,
                beat_type="action",
                beat_summary="（Zou Xiang doorway）",
...
def test_audio_timeline_storyboard_ai_prompt_does_not_leak_dialogue_text() -> None:
        ...
        "beats": [
            {
                ...
                "text": "Ni Gei Wo Jie Shi Qing Chu！",
                "start_ms": 0,
                "end_ms": 1000,
            }
        ]
    ...
    assert "Ni Gei Wo Jie Shi Qing Chu" in frames[0]["description"]
    assert "Ni Gei Wo Jie Shi Qing Chu" not in (frames[0].get("ai_prompt") or "")
        ...
        "beats": [
            {
                ...
                "beat_type": "dialogue",
                "speaker_name": "Lin Wan",
                "text": "Li Hun Xie Yi.pdf Ni Dao Di Xiang Gan Shen Me？",
                "start_ms": 0,
                "end_ms": 1000,
            }
        ]
