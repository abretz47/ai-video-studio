...
def test_build_episode_timeline_beats_offsets_scene_windows() -> None:
 ...
 order_index=1,
 beat_type="dialogue",
 dialogue_excerpt="Ni Hao",
 duration_seconds=1.0,
 extra_metadata={"start_ms": 0, "end_ms": 1000, "speaker_name": "Xiao Ming"},
),
 SceneBeat(
 id=12,
 scene_id=1,
 ...
 order_index=1,
 beat_type="action",
 beat_summary="(Zou Xiang Men Kou)",
...
def test_pad_episode_timeline_to_target_adds_action_beats() -> None:
 ...
 assert "countdown" in padding_beats[0]["text"]
...
def test_audio_timeline_storyboard_ai_prompt_does_not_leak_dialogue_text() -> None:
 ...
 "text": "you Gei Wo Jie Shi Qing Chu!",
 "start_ms": 0,
 "end_ms": 1000,
 }
 ]
 ...
 assert "you Gei Wo Jie Shi Qing Chu" in frames[0]["description"]
 assert "you Gei Wo Jie Shi Qing Chu" not in (frames[0].get("ai_prompt") or "")
 assert "Kai Kou Shuo Hua" in (frames[0].get("ai_prompt") or "")
 assert "no subtitles" in (frames[0].get("ai_prompt") or "")
...
def test_audio_timeline_storyboard_prompt_description_blurs_readable_text() -> None:
 ...
 "beat_type": "dialogue",
 "speaker_name": "Lin Wan",
 "text": "Li Hun Xie Yi.pdf you Dao Di Xiang Gan Shen Me?",
 "start_ms": 0,
 "end_ms": 1000,
 }
 ]
 ...
 assert "screen Wen Zi Mo Hu Bu Ke Du" in (frames[0].get("ai_prompt") or "")
