...
async def test_outline_logline_only(monkeypatch):
    ...
    outline = {"episodes": [{"episode_number": 1, "title": "E1", "logline": "hook"}]}
    episode = {
        "episodes": [
            {
                "episode_number": 1,
    ...
    assert result["step_outlines"]["episodes"][0]["logline"] == "hook"
...
async def test_outline_missing_logline_triggers_repair(monkeypatch):
    ...
    outline_fixed = {
        "episodes": [{"episode_number": 1, "title": "E1", "logline": "repair after"}]
    }
    episode = {
        "episodes": [
            {
    ...
    assert result["step_outlines"]["episodes"][0]["logline"] == "repair after"
