...
async def test_generate_zhihu_plan_compact_falls_back_when_chapters_missing():
 story_payload = {
 "title": "Cheng Xu Yuan Zhi Wo Jia Diao Xia Lai Ge?Lin Mei?Qi Xian Nv?Bu!Shi Ge Guo Gai～～～～",
 "episodes": [
 {
 "episode_number": 1,
 "title": "Kai Duan",
 "summary": "Protagonist Zai Jia Ban Shi Yu Dao Li Qi Shi Jian, Sheng Huo Bei Che Di Da Luan.",
