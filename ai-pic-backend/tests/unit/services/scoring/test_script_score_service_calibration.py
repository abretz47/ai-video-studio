...
async def test_score_script_calibrates_when_commercial_anchors_are_present(
 ...
 script = """
 Zhang Zong: 60seconds, He Tong Zuo Fei!
 AP: Shu Zi Bu Hui Sa Huang, Kan Shi Jian Chuo.
 ▲Xiao Chen Suo Ding Yun Duan Ri Zhi, Xiao Chen Heng Zai doorway Dang Zhu Chen Mo.
 ▲Chen Mo Shou Zhi Xuan Zai delete confirm Jian.
 ▲Chen Mo phone Tong Zhi Lan Tiao Chu"Gai Wan Gei Ni20Wan".
 ▲Chen Mo phone Dan Chu20Wan Dao Zhang Duan Xin, Xia Yi Tiao Xie Zhe: Nv Er Zhu Yuan Fei Wo Chu, Bu Zuo Jiu Cai you.
 ▲APBa Yuan Shi file, Yun Duan Ri Zhi time Chuo, recording, Hui Yi Ji Yao He Duan Xin Bing Pai Tou Ping.
 Zhang Zong: 15seconds.
 ▲APphone Dan Chu Ni Ming Duan Xin: Yuan Shi file Jiang Zai30Miao Hou Shan Chu, Xia Yi Ge Ting Zhi De Shi you.
 """

 result = await score_service.score_script(
 script_content=script,
 story={"title": "APQuan Lian Lu return Yang Pian"},
 episode={"episode_number": 1, "title": "Shu Ju Mi Ju"},
)
