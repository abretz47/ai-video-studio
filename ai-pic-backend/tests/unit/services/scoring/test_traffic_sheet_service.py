            ...
            "assets": [
                {
                    ...
                    "key_line": "Ni Yi Wei Wo not Zhi Dao？",
                    "visual_hook": "heroine Shuai Men",
                    "shot_list": ["close-up：angry Yan Shen", "medium shot：Jing Huang"],
                ...
                },
                {
                    ...
                    "shot_list": ["close shot：Zheng Ju"],
                    "cliff_or_cta": "continue Kan"
                }
            ]
        }
        ```
