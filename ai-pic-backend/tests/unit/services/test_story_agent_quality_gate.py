...
def _weak_outline() -> dict:
 ...
 {"name": "Lin Wan", "description": "Zhi Chang Dui Shou"},
 ...
 "hook_plan": {"opening_hook": "general De Yi Tian start Le.", "key_reversals": []},
 "selling_points": ["Du Shi Gu Shi"],
 "cliffhanger_plan": ["Xia Ji Ji Xu"],
 "ad_snippets": [
 {
 "duration_seconds": 15,
 "hook": "Ji Xu Guan Kan",
 "visual_summary": "Jue Se Liao Tian",
 "call_to_action": "Ji Xu Kan",
 }
 ],
 }
...
async def test_story_agent_repairs_when_outline_fails_quality_or_character_gate():
 ...
 title="Wo De Sheng Huo Bei Gou Xue Bao Wei",
 ...
 assert (
 result["normalized"]["main_characters"][1]["name"] == "Lin Wan_Shuang Ju Ce Shi_01300519"
)
