...
async def test_script_gate_refreshes_stale_unknown_speaker_flag_without_creation() -> None:
 ...
 "dialogues": [
 {"scene_number": 1, "character": "AP", "content": "Zheng Ju Zai Zhe."},
 {"scene_number": 1, "character": "Duan Xin", "content": "Xia Yi Ge Jiu Shi you."},
 ],
 "stage_directions": [{"scene_number": 1, "content": "APJu Qi Shou Ji."}],
 "metadata": {},
 }
