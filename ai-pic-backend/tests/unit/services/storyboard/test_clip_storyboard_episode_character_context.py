...
def test_clip_storyboard_context_binds_episode_character_ip(db_session):
    ...
    result = build_clip_storyboard_context(
        ...
        clip={
            ...
            "text": "courier Yuan Bao Guo Di Jin Men。",
        },
...
def test_clip_storyboard_context_prefers_explicit_ip_over_text_match(db_session):
    ...
    courier = _add_episode_character(db_session, episode.id, user.id, "courier Yuan")
    timeline = create_timeline(
        db_session,
        episode,
        script,
    ...
    result = build_clip_storyboard_context(
        ...
        clip={
            ...
            "text": "Lin Wan Kan Zhe courier Yuan Di Lai Bao Guo。",
        },
...
def test_clip_storyboard_context_prefers_request_ip_selection(db_session):
    ...
    result = build_clip_storyboard_context(
        ...
        clip={
            "clip_id": "clip-1",
            "track_type": "video",
            "text": "Lin Wan Da Kai Men，Jie Guo courier Yuan Di Lai Bao Guo。",
        },
...
def _add_episode_character(
    ...
    slug = "courier" if name == "courier Yuan" else name
    virtual_ip = VirtualIP(
        user_id=user_id,
        name=name,
        description=f"{name} character profile",
