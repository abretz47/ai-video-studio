    ...
    panels = [
        {
            "panel_index": 1,
            "clip_id": "clip-1",
            "visual_prompt": "Lin Wan Zhan in rainy night doorway",
            "direction_anchor": "rainy night doorway lonely search",
            "bound_context": {
                "characters": [
                    {
                        "name": "Lin Wan",
...
def test_clip_storyboard_video_prompt_uses_motion_sections():
    panel = {
        "panel_index": 1,
        "clip_id": "clip-1",
        "video_prompt": "Chuan Shen Se Xi Zhuang Nan Ren Zuo Zai Che INT，rainy night Ni Hong Fan She in Che Chuang on",
