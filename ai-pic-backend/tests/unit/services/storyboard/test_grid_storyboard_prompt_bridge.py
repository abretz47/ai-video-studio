...
def test_build_grid_storyboard_panels_prefers_timeline_shot_plan_prompts():
 ...
 "timeline_shot_plan": {
 "shot_id": "shot-1",
 "visual_prompt": "Lin Wan Zhan Zai rainy night doorway, Ni Hong Fan Guang, medium shot",
 "video_prompt": "camera Huan Man Tui Jin, Yu Shui Luo Zai Ta Jian Tou",
 "direction_anchor": "a lonely search toward the rainy-night doorway",
 "aesthetic_reference": "IMAX film, Panavision C lens",
 "composition_geometry": "Lin Wan Zai Zuo San Fen Xian, Men Kuang Qie Fen You Ce Fu Kong Jian",
 "motion_timeline": [
 ...
 assert panel["visual_prompt"] == "Lin Wan Zhan Zai rainy night doorway, Ni Hong Fan Guang, medium shot"
 assert panel["video_prompt"] == "camera Huan Man Tui Jin, Yu Shui Luo Zai Ta Jian Tou"
 assert panel["direction_anchor"] == "a lonely search toward the rainy-night doorway"
 assert panel["aesthetic_reference"] == "IMAX film, Panavision C lens"
 assert panel["composition_geometry"] == "Lin Wan Zai Zuo San Fen Xian, Men Kuang Qie Fen You Ce Fu Kong Jian"
 assert panel["motion_timeline"][2]["at_ms"] == 2800
 assert panel["emotional_landing"] == "restrained loneliness in the cold rain"
...
def test_build_clip_storyboard_panels_diversifies_clip_text_fallback():
 ...
 "start_ms": 36260,
 "end_ms": 45444,
 "text": "Chu Fang Yu Kai Fang Shi Can Ting Xiang Lian.Old Guai He A Gai Er Zhan Zai Zhong Dao Tai Pang.",
 "source_refs": {},
 }
...
def test_grid_sheet_and_video_prompts_constrain_text_and_panel_scope():
 ...
 "panel_index": 2,
 "clip_id": "clip-2",
 "visual_prompt": "Chen Zhe Zuo Zai Che INT, Ce Lian Bei phone Ping Zhao Liang",
 ...
 assert "Lin Wan Zhan Zai rainy night doorway" in sheet_prompt
 assert "IMAX film" in sheet_prompt
 assert "Men Kuang Qie Fen You Ce Fu Kong Jian" in sheet_prompt
 assert "0ms Lin Wan Ting Zai doorway" in sheet_prompt
 assert "restrained loneliness in the cold rain" in sheet_prompt
