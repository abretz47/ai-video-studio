...
def test_audio_timeline_storyboard_enricher_injects_cards_and_reference_images(
 ...
 name="Duan Ju Nv Zhu-Lin Wan-2026-01-30T00-00-00Z",
 ...
 "prompt_description": "main subject: Shu Ping short drama Dan camera, Lin Wan Zheng Zai Kai Kou Shuo Hua.Biao Yan Dong Zuo: Yan Shen Zhui Wen Dui Fang.Jin Zhi Xiang: Dan Fu Hua Mian, no subtitles, Wu Ke Du Wen Zi.",
 }
 ]
 ...
 assert "Huan Jing Mao Dian:" in frames[0]["prompt_description"]
 assert "Gong Yu Ke Ting" in frames[0]["prompt_description"]
...
def test_audio_timeline_storyboard_enricher_does_not_override_manual_reference_images(
 ...
 "scene_number": 1,
 "characters": ["Lin Wan"],
 "prompt_description": "main subject: Shu Ping short drama Dan camera, Lin Wan Zheng Zai Kai Kou Shuo Hua.",
