...
class TestVisualContinuityValidator:
 ...
 "visual_description": "Alicewearing red Qun Zi Zhan Zai doorway",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Alice"}],
 ...
 "frame_number": 2,
 "characters": [{"name": "Alice"}],
 "visual_description": "AliceChuan Zhe Xi Zhuang",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "frame_number": 1,
 "characters": [{"name": "Bob"}],
 "visual_description": "BobYou Zhe Duan Fa, Zhan Zai Chuang Bian",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Bob"}],
 "visual_description": "BobDuan Fa, Zuo Zai Yi Zi Shang",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "frame_number": 2,
 "characters": [{"name": "Dan"}],
 "visual_description": "DanKan Zhe Shou Zhong De phone",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "frame_number": 1,
 "characters": [{"name": "Eve"}],
 "visual_description": "EveZhan Zhe",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Eve"}],
 ...
 "frame_number": 3,
 "characters": [{"name": "Eve"}],
 "visual_description": "EveZhan Zhe Si Kao",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "visual_description": "FrankZhan Zai frame Zuo Ce",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Frank"}],
 ...
 "visual_description": "GraceZhan Zai frame Zuo Ce",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Grace"}],
 "visual_description": "GraceChu Xian Zai frame You Ce",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "visual_description": "HenryZuo Zhe Kan Shu",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Henry"}],
 "visual_description": "HenryZhan Zhe Shen Lan Yao",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "visual_description": "IrisTang Zhe Shui Jiao",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Iris"}],
 ...
 {
 "frame_number": 1,
 "visual_description": "character An rule of thirds Gou Tu Fang Zhi Zai frame You San Fen Zhi Yi Chu",
 },
 {
 "frame_number": 2,
 "visual_description": "San Fen Gou Tu, Zhu Ti Zai Jiao Cha Dian",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "frame_number": 1,
 "beat_type": "dialogue",
 "dialogue": "Ni Hao, Hen Gao Xing Ren Shi you",
 "characters": [{"name": "Kate"}],
 "visual_description": "KateZhan Zai Na Li",
 },
 {
 "frame_number": 2,
 "beat_type": "dialogue",
 ...
 "characters": [{"name": "Kate"}],
 "visual_description": "KateWei Xiao Zhe",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 desc = "Ta wearing red Qun Zi, Shou Li Na Zhe Bao"
 ...
 desc = "Ta You Zhe Chang Fa, Fa Se Shi Hei Se De"
 ...
 assert validator._extract_position("Zhan Zai frame Zuo Ce") == "left"
 assert validator._extract_position("Zai Zhong Yang Wei Zhi") == "center"
 assert validator._extract_position("Zai frame You Bian") == "right"
 ...
 assert validator._extract_pose("Ta Zuo Zai Yi Zi Shang") == "sitting"
 assert validator._extract_pose("Ta Zhan Zhe") == "standing"
 ...
 "frame_number": 1,
 "characters": [{"name": "Leo"}],
 "visual_description": "Leowearing Xi Zhuang Zhan Zai frame Zuo Ce, Shuo Hua Zhong",
 "beat_type": "dialogue",
 "dialogue": "Ni Hao",
 },
 {
 ...
 "beat_type": "dialogue",
 "dialogue": "Hen Gao Xing Jian Dao you",
 },
 {
 "frame_number": 3,
 "characters": [{"name": "Leo"}],
 "visual_description": "Leowearing Xi Zhuang Zhan Zai Zhong Yang, An rule of thirds Gou Tu",
 "beat_type": "action",
 },
 ]
 results = validator.validate(base_state, mock_context)
 ...
 "frame_number": 1,
 "characters": [{"name": "Mia"}],
 "visual_description": "Miawearing Qun Zi Zhan Zai Zuo Ce",
 "beat_type": "dialogue",
 "dialogue": "Hello",
 },
 {
 "frame_number": 2,
 "characters": [{"name": "Mia"}],
 "visual_description": "Miawearing Xi Zhuang Chu Xian Zai You Ce",
 "beat_type": "dialogue",
 "dialogue": "World",
 },
 ]
