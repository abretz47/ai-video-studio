...
def _strong_outline() -> dict:
    return {
        ...
        "selling_points": ["opening public Xiu Ru", "Gao Ya counterattack", "truth reveal", "workplace Ni Xi", "Qiang Ka Dian"],
...
def _strong_outline_with_contract() -> dict:
    ...
    outline["structured_story_contract"] = {
        "target_audience": "urban workplace Ni Xi user",
        "core_emotional_pain": "professional Neng Li be public Zhi Yi，Xin Ren be Nei Bu Ren betrayal",
        "big_expectation": "Wen Wen Cha Qing data Cuan Gai truth and Duo Hui project Zhu Dao Quan",
        "small_expectation_ladder": [
            "before San Ji Na Dao Hui Yi recording",
            "Di8-12Ji Bi Chu Cuan Gai data Ren",
            "Di20-30Ji public Mu Hou Jiao Yi Zheng Ju",
        ],
        "protagonist_goal": "San Tian INT Zhao Chu Cuan Gai data Nei Bu Ren",
        "structural_conflict": "Wen Wen Bi Xu Jie Yong Zhi Yi Ta team Zi Yuan Fan Cha team Nei Bu mastermind",
        "information_gap": "audience Zhi Dao recording exists，Dui Shou not Zhi Dao key camera already be Pai Xia",
        "first_three_episode_spine": "identity、Zheng Ju、He Xin conflict before San Ji Li Zhu",
