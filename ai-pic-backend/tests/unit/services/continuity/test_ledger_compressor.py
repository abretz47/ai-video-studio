...
class TestScoreFact:
    ...
    def test_base_score_for_simple_fact(self):
        score = score_fact("Zhang San Qu Shang Dian", set())
        assert score >= 1.0  # Base score

    def test_high_importance_keywords_boost_score(self):
        base = score_fact("Zhang San Qu Shang Dian", set())
        important = score_fact("John Doe truth identity be reveal", set())
        assert important > base

    def test_character_involvement_boosts_score(self):
        chars = {"John Doe", "Jane Roe"}
        no_chars = score_fact("someone Qu Shang Dian", chars)
        one_char = score_fact("Zhang San Qu Shang Dian", chars)
        two_chars = score_fact("John Doe and Jane Roe Qu Shang Dian", chars)

        assert one_char > no_chars
        assert two_chars > one_char

    def test_longer_facts_get_slight_bonus(self):
        short = score_fact("Zhang San Qu Shang Dian", set())  # 6 chars
        # Need > 50 chars for first bonus, > 100 for second bonus
        medium_text = "Zhang San Zai Shen Ye Du Zi Qu Cheng Dong Shang Dian Mai Dong Xi Hui Jia" * 3  # ~54 chars (>50)
        medium = score_fact(medium_text, set())
        very_long_text = (
            "Zhang San Zai Shen Ye Du Zi Qu Cheng Dong Shang Dian Mai Yi Xie Shi Wu and Sheng Huo Yong Pin Ran Hou Hui Jia" * 4
        )  # ~116 chars (>100)
...
class TestScoreTimelineItem:
    ...
    def test_end_state_boosts_score(self):
        ...
        with_state = {"episode_number": 5, "end_state": "John Doe Li Kai city"}
    ...
    def test_anchors_boost_score(self):
        ...
        with_anchors = {
            ...
            "location_anchor": "city Zhong Xin",
        }
...
class TestScoreThread:
    ...
    def test_question_marks_boost_score(self):
        statement = "John Doe Li Kai city"
        question = "John Doe why Li Kai city？"
...
class TestScoreInfoEvent:
    ...
    def test_important_how_method_boosts_score(self):
        ...
        reveal = {"episode_number": 5, "who": "audience", "what": "information", "how": "reveal truth"}
...
class TestCompressLedgerByPriority:
    ...
    def test_preserves_characters_unchanged(self):
        ledger = {
            "characters": {
                "John Doe": {"status": "active", "goal": "Zhao Dao truth"},
    ...
    def test_prioritizes_important_facts(self):
        ...
        assert "key identity truth be reveal" in result["facts"]
    ...
    def test_prioritizes_recent_timeline_items(self):
        ledger = {
            "timeline": [
                ...
                {"episode_number": 5, "reveals": ["Zhong Da reveal"], "end_state": "key Jie Ju"},
    ...
    def test_prioritizes_threads_with_characters(self):
        ledger = {
            ...
            "open_threads": [
                "Mou Ren in Deng Dai",
                "John Doe Mi Mi identity Xuan Nian",
                "Tian Qi Bian Hua",
                "Jane Roe key Ren Wu？",
            ],
        }
    ...
    def test_handles_non_dict_items_gracefully(self):
        ledger = {
            "facts": ["normal Shi Shi", None, "", "Ling Yi Ge Shi Shi"],
    ...
    def test_integration_with_realistic_ledger(self):
        ...
        ledger = {
            ...
            "facts": [
                ...
                "key truth：Jane Roe is undercover",
                "office in Shi Zhong Xin",
            ...
            "timeline": [
                {
                    ...
                    "events": ["John Doe Dao Da"],
                    "end_state": "story start",
                    "reveals": [],
                },
                {
                    "episode_number": 2,
            ...
            "characters": {
                "John Doe": {
                    ...
                    "known_info": ["company have issue"],
                    "unknown_info": ["Jane Roe is undercover"],
                },
                "Jane Roe": {
                    "status": "Yin Cang identity",
                    "goal": "complete Ren Wu",
            ...
            "info_acquisition_events": [
                {
                    "episode_number": 1,
                    "who": "audience",
                    "what": "John Doe Bei Jing",
                    "how": "voiceover",
                },
                {
                    "episode_number": 2,
                    "who": "John Doe",
                    "what": "discover Zheng Ju",
                    "how": "Mu Ji",
                },
            ],
            "open_threads": [
                "Jane Roe Zhen Shi identity is Shen Me？",
                "company Mi Mi？",
            ],
            "resolved_threads": ["John Doe Dong Ji already Ming Que"],
        }
