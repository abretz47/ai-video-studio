...
test Zui Zhong when Zhang validate function。
"""
...
class TestFinalValidationNode:
    ...
    def test_validation_passes_exact_match(self, base_state):
        """test Jing Que Pi Pei when validate pass"""
    ...
    def test_validation_passes_within_tolerance(self, base_state):
        """test in Rong Cha Fan Wei INT validate pass"""
        # set actual duration for target 95%（in ±10% Rong Cha INT）
    ...
    def test_validation_fails_too_short(self, base_state):
        ...
        # set actual duration for target 85%（Chao Chu ±10% Rong Cha）
    ...
    def test_validation_fails_too_long(self, base_state):
        """test when Zhang Guo Chang when validate failed"""
        # set actual duration for target 115%（Chao Chu ±10% Rong Cha）
    ...
    def test_validation_boundary_lower(self, base_state):
        """test Xia Bian Jie（Gang Hao in Rong Cha INT）"""
        # 90% = 162seconds
    ...
    def test_validation_boundary_upper(self, base_state):
        """test on Bian Jie（Gang Hao in Rong Cha INT）"""
        # 110% = 198seconds
    ...
    def test_validation_updates_reasoning_pass(self, base_state):
        """Ce Shi Tong Guo when update Tui Li Ri Zhi"""
        result = final_validation_node(base_state)
    ...
    def test_validation_updates_reasoning_fail(self, base_state):
        """test failed when update Tui Li Ri Zhi"""
