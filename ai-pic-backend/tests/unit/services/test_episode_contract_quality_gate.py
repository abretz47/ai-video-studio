...
def test_episode_gate_accepts_structured_contract_when_required() -> None:
 ...
 episode["cliffhanger"] = "ledger final Yi Ye Lu Chu Lin Xue Fu Qin De signature."
 episode["structured_episode_contract"] = {
 "episode_goal": "Lin Xue Duo to ledger",
 "ignition_0_3s": "Lin Xue Zhuang Kai Men, ledger Bei Chen Mo Sai Jin Bao Xian Xiang.",
 ...
 "payoff": "Lin Xue Yong phone recording counterattack, Na Dao Zhang Ben.",
 "final_button_cliffhanger": "ledger final Yi Ye Chu Xian Fu Qin signature.",
 "visual_anchor": "phone recording Jie Mian close-up, Lin Xue Zuan Jin ledger De Shou.",
 "information_delta": "audience De Zhi Fu Qin possible Can Yu Jiu An.",
