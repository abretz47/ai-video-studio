...
class RecordingAIManager:
    ...
    async def generate_text(self, **kwargs):
        ...
        if "only output Zhong Wen prompt Ci" in kwargs["prompt"]:
        ...
        payload = {
            ...
            "background_story": "from Ji Ceng Yi Lu Cheng Zhang for He Huo Ren，Xi Guan Yong Shi Shi Jie Jue crisis。",
            "personality": "Li Xing、Ke Zhi、Zhong Qing Yi",
            "skills": "Tan Pan、Feng Kong、Kuai Su Jue Ce",
            "relationships": "and team keep Yan Ge Dan Ke Kao Huo Ban Guan Xi",
            "lifestyle": "Gao Qiang Du work，Zhong Shi Chang Qi Cheng Nuo",
            "signature_traits": "Hei Se Xi Zhuang and calm Mu Guang",
            "development_potential": "Shi He modern Shang Zhan and Fu Chou Cheng Zhang Xian",
