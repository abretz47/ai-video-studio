        ...
        async def generate_text(self, prompt: str, **_: Any) -> Any:
            ...
            return SimpleNamespace(
                ...
                data=(
                    ...
                    '"summary":"opening hook：HeroZhuang Kai Men discover Zheng Ju be Suo。",'
                    '"visual_anchor":"HeroShou Zhi An Zhu Bao Xian Xiang",'
                    '"action_obstacle_cost":"HeroZhuang Men/Bao Xian Xiang Zu Dang/Bao Lu recording/Xuan Ze public Zheng Ju/signature Chu Xian",'
                    '"dialogue_function":"reveal"}],'
                    '"structured_episode_contract":{"episode_goal":"Qiang Hui Zheng Ju",'
                    '"ignition_0_3s":"HeroZhuang Kai Men",'
                    '"first_30s_reason":"Zheng Ju Ji Jiang delete",'
                    '"midpoint_jolt":"Dui Shou Fan Suo Bao Xian Xiang",'
                    '"payoff":"HeroBo Fang recording",'
                    '"final_button_cliffhanger":"Zheng Ju back view Chu Xian Xin signature",'
                    '"visual_anchor":"phone recording and Shou Bu close-up",'
                    '"information_delta":"Xin signature Zhi Xiang mastermind",'
