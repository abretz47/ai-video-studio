...
def test_build_script_text_uses_commercial_vertical_format():
 ...
 "summary": "Kai Chang Gou Zi: Lin Xue Dang Zhong Shuai Chu ledger.",
 }
 ],
 dialogues=[
 {
 "scene_number": 1,
 "character": "Lin Xue",
 "content": "Zhang Ben Zai Zhe, you Hai Yao Zhuang Ma?",
 "emotion": "Leng Xiao",
 },
 {
 "scene_number": 1,
 "character": "Chen Mo",
 "content": "you Zen Me Hui You it?",
 "emotion": "Huang Luan",
 },
 ],
 stage_directions=[
 ...
 "scene_number": 1,
 "timing": "intro",
 "content": "【sound effect】Peng!Men Bei Chuai Kai, Zhong Ren Hui Tou.",
 "type": "sfx",
 },
 {
 "scene_number": 1,
 ...
 assert "▲【sound effect】Peng!Men Bei Chuai Kai" in text
 assert "Lin Xue(Leng Xiao): Zhang Ben Zai Zhe, you Hai Yao Zhuang Ma?" in text
