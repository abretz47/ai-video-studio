...
def test_missing_dialogue_extracts_quoted_scene_lines_before_narration():
 ...
 "description": (
 "Old Guai Zuo Zai Dian Nao Qian, screen Gun Dong Zhe Dai Ma.Ta Wei Wei Yi Xiao: 'You Yi Ge Zi Dong Hua complete Le.'"
 ...
 ("Old Guai", "You Yi Ge Zi Dong Hua complete Le.", None),
...
def test_missing_dialogue_keeps_speakers_when_quotes_are_adjacent():
 ...
 "characters": ["Old Guai", "Wen Wen"],
 "description": (
 "Wen Wen Zhu Yi to Le Lao Guai De Dai Ma screen.'Zhe Xie Shi Shen Me?'Ta Zhi Zhe Yi Chuan data Wen."
 "Lao Guai Song Jian: 'Sheng Cun Suan Fa, Ji Suan Mei Ge Ren De Jia Zhi.'"
 "Wen Wen Zhou Mei: 'you Shi Zai Gei Ren Tie Biao Qian Ma?'"
 "Lao Guai Wu Nai: 'Xiao Lv Zhi Shang.'"
 "Wen Wen Jian Ding: 'Wo Hui Liu Xia, Bang you Jia Dian Ren Xing Hua.'"
),
 }
 ]
 ...
 ("Wen Wen", "Zhe Xie Shi Shen Me?"),
 ("Old Guai", "Sheng Cun Suan Fa, Ji Suan Mei Ge Ren De Jia Zhi."),
 ("Wen Wen", "you Shi Zai Gei Ren Tie Biao Qian Ma?"),
 ("Old Guai", "Xiao Lv Zhi Shang."),
 ("Wen Wen", "Wo Hui Liu Xia, Bang you Jia Dian Ren Xing Hua."),
 ]
