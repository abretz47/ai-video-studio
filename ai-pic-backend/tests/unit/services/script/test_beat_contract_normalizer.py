...
def _valid_contract():
 ...
 "logline": "robot discover bonus reset to zero, Bi Xu Zhao Chu Shui Gai Le Shi Jian Zhou.",
 "scenes": [
 {
 "scene_number": 1,
 ...
 "dramatic_role": "hook",
 "conflict": {
 "question": "Shui Qing Kong Le bonus?",
 "stakes": "60seconds INT Zhao Bu Dao Jiu Yong Jiu Diu Shi bonus.",
 "opposition": "Bei Cuan Gai De Shi Jian Zhou system.",
 "turn": "countdown suddenly Qi Dong.",
 },
 "beats": [
 {
 "order_index": 1,
 "beat_type": "hook",
 "dramatic_purpose": "Zhi Jie Pao Chu Sun Shi He time Ya Li.",
 ...
 "order_index": 2,
 "beat_type": "reveal",
 "dramatic_purpose": "Zheng Ming Xiao Ji Zhao Dao Di Yi Duan evidence.",
 ...
 "dialogue_lines": [
 {"character": "Xiao Ji", "content": "evidence Chu Lai Le."}
 ],
 "duration_seconds": 6,
 ...
 "action_lines": [{"content": "Ri Zhi Mo Xing Bei Hei Se Guang Biao Tun Diao."}],
 "dialogue_lines": [
 {"character": "Xiao Ji", "content": "Shui Hai Zai Xian?"}
 ],
 "duration_seconds": 6,
...
def test_content_normalization_preserves_scene_beats():
 ...
 assert normalized["scenes"][0]["summary"] == "Shui Qing Kong Le bonus?"


@pytest.mark.unit
def test_content_normalization_coerces_numeric_estimated_duration_metadata():
 payload = {
 "content": "Di1Chang\nXiao Ji: evidence Chu Lai Le.\n▲Ri Zhi Mo Xing Bei Hei Se Guang Biao Tun Diao.",
 "scenes": [
 {
 "scene_number": 1,
 ...
 "scene_number": 1,
 "character": "Xiao Ji",
 "content": "evidence Chu Lai Le.",
 }
 ],
 "stage_directions": [
 {
 "scene_number": 1,
 "content": "Ri Zhi Mo Xing Bei Hei Se Guang Biao Tun Diao.",
 }
 ],
