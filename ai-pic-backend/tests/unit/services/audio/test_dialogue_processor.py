...
class TestNormName:
 ...
 """Test Chinese name."""
 assert norm_name("Zhang San") == "John Doe"
...
class TestLooksLikeSilence:
 ...
 assert looks_like_silence("(Chen Mo)") is True
 ...
 assert looks_like_silence("Ni Hao") is False
...
class TestSanitizeDialogueContent:
 ...
 text, action = sanitize_dialogue_content("Ni Hao")
 assert text == "Ni Hao"
 assert action is None

 def test_leading_action(self):
 """Test leading inline action extraction."""
 text, action = sanitize_dialogue_content("(Tan Qi)Ni Hao")
 assert text == "Ni Hao"
 assert action == "Tan Qi"

 def test_trailing_action(self):
 """Test trailing inline action extraction."""
 text, action = sanitize_dialogue_content("Ni Hao(Zhuan Shen Li Kai)")
 assert text == "Ni Hao"
 assert action == "Zhuan Shen Li Kai"

 def test_both_actions(self):
 """Test both leading and trailing actions."""
 text, action = sanitize_dialogue_content("(Tan Qi)Ni Hao(Zhuan Shen)")
 assert text == "Ni Hao"
 assert "Tan Qi" in action
 assert "Zhuan Shen" in action

 def test_speech_attribution(self):
 """Test speech attribution extraction."""
 text, action = sanitize_dialogue_content("Xiao Zhe Shuo: Ni Hao")
 assert text == "Ni Hao"
 assert "Xiao Zhe Shuo" in action

 def test_existing_action(self):
 """Test preserving existing action."""
 text, action = sanitize_dialogue_content("Ni Hao", action="existing action")
 assert text == "Ni Hao"
...
class TestPlanSceneSegments:
 ...
 dialogue_segments = [s for s in result if s.kind == "dialogue"]
 assert dialogue_segments[0].speaker_name == "voiceover"
