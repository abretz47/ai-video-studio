...
def _timeline_spec_with_shot_plan(
 ...
 "direction_anchor": "Chao Xiang robot discover Men Suo Mi Mi De suspense camera",
...
def test_build_storyboard_frames_from_timeline_spec_marks_source():
 ...
 assert "Shu Ping short drama Dan camera" in frames[0]["prompt_description"]
 assert "Jin Zhi Xiang:" in frames[0]["prompt_description"]
...
def test_build_storyboard_frames_from_timeline_spec_prefers_shot_plan():
 ...
 "Chao Xiang robot discover Men Suo Mi Mi De suspense camera"
)
...
def test_generate_storyboard_support_from_timeline_spec_persists_meta(db_session):
 ...
 assert "main subject:" in frame["prompt_description"]
 assert "short drama Shu Ping camera prompt:" in frame["ai_prompt"]
 assert "Tong Yi Yao Qiu:" in frame["ai_prompt"]
