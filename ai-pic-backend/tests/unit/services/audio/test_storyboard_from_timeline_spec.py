            ...
            "clips": [
                {
                    ...
                    "source_refs": {
                        ...
                        "timeline_shot_plan": {
                            ...
                            "direction_anchor": "Chao Xiang robot discover Men Suo Mi Mi suspense camera",
...
def test_build_storyboard_frames_from_timeline_spec_marks_source():
    ...
    assert "vertical short drama Dan camera" in frames[0]["prompt_description"]
...
def test_build_storyboard_frames_from_timeline_spec_prefers_shot_plan():
    ...
    assert frames[0]["shot_plan_prompt_layers"]["direction_anchor"] == (
        "Chao Xiang robot discover Men Suo Mi Mi suspense camera"
    )
...
def test_generate_storyboard_support_from_timeline_spec_persists_meta(db_session):
    ...
    assert "short drama vertical camera prompt:" in frame["ai_prompt"]
