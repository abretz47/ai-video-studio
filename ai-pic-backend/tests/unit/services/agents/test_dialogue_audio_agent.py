...
class TestDialogueAudioAgent:
    ...
    def test_detect_emotion_happy(self, agent: DialogueAudioAgent) -> None:
        ...
        emotion, confidence = agent.detect_dialogue_emotion(
            "Tai Hao Le！Wo Tai happy！", language="zh"
        )
    ...
    def test_detect_emotion_sad(self, agent: DialogueAudioAgent) -> None:
        ...
        emotion, confidence = agent.detect_dialogue_emotion(
            "Wo Hao Shang Xin，Zhen De Tai Nan Guo", language="zh"
        )
    ...
    def test_detect_emotion_angry(self, agent: DialogueAudioAgent) -> None:
        ...
        emotion, confidence = agent.detect_dialogue_emotion(
            "Wo Fei Chang angry！Tai Qi Fen！", language="zh"
        )
    ...
    def test_detect_emotion_with_action(self, agent: DialogueAudioAgent) -> None:
        ...
        emotion, _ = agent.detect_dialogue_emotion(
            "Hao", action_hint="Di Sheng Shuo Dao", language="zh"
        )
    ...
    def test_validate_emotion_alignment_mismatch(
        ...
        dialogues = [
            {
                "character": "Alice",
                "content": "Wo Fei Chang angry！Tai Sheng Qi！",
    ...
    def test_validate_emotion_transition_abrupt(
        ...
        dialogues = [
            {"character": "Alice", "content": "Wo Tai happy！Ha Ha！"},
    ...
    def test_validate_speech_rhythm_normal(self, agent: DialogueAudioAgent) -> None:
        ...
        dialogues = [
            {
                "character": "Alice",
                "content": "Zhe Shi Yi Duan normal speech rate dialogue",  # 10 chars
    ...
    def test_validate_speech_rhythm_too_fast(self, agent: DialogueAudioAgent) -> None:
        ...
        dialogues = [
            {
                "character": "Alice",
                "content": "Zhe Shi Yi Duan Fei Chang Fei Chang Zhang dialogue content Xu Yao Hen Kuai Shuo Wan",  # ~20 chars
    ...
    def test_create_render_plan_emotion_detection(
        ...
        dialogues = [
            {
                "character": "Alice",
                "content": "Tai happy！Wo Hao Gao Xing！",
            },
        ]
        result = agent_with_voices.create_render_plan(dialogues)
    ...
    def test_full_workflow(self, agent_with_voices: DialogueAudioAgent) -> None:
        ...
        dialogues = [
            {
                "character": "Alice",
                "content": "Ni Hao，Hen Gao Xing Ren Shi Ni",
                "start_time_ms": 0,
                "duration_ms": 1500,
            },
            {
