...
class TestDialogueAudioAgent:
 ...
 "Tai Hao Le!Wo Tai happy Le!", language="zh"
)
 ...
 emotion, confidence = agent.detect_dialogue_emotion(
 "Wo Hao Shang Xin, Zhen De Tai Nan Guo Le", language="zh"
)
 ...
 emotion, confidence = agent.detect_dialogue_emotion(
 "Wo Fei Chang angry!Tai Qi Fen Le!", language="zh"
)
 ...
 "Hao De", action_hint="Di Sheng Shuo Dao", language="zh"
)
 ...
 emotion, _ = agent.detect_dialogue_emotion("Jin Tian Tian Qi Bu Cuo", language="zh")
 ...
 {
 "character": "Alice",
 "content": "Wo Tai happy Le!",
 "tts_emotion": "happy",
 },
 {
 "character": "Bob",
 "content": "Wo Ye Hen Gao Xing",
 "tts_emotion": "happy",
 },
 ]
 ...
 {
 "character": "Alice",
 "content": "Wo Fei Chang angry!Tai Sheng Qi Le!",
 ...
 dialogues = [
 {"character": "Alice", "content": "Wo Tai happy Le!Ha Ha!"},
 {"character": "Alice", "content": "Wo Fei Chang angry!"}, # Abrupt change
 ]
 issues = agent.validate_emotion_alignment(dialogues)
 ...
 {
 "character": "Alice",
 "content": "Zhe Shi Yi Duan normal speech rate De dialogue", # 10 chars
 ...
 {
 "character": "Alice",
 "content": "Zhe Shi Yi Duan Fei Chang Fei Chang length De dialogue content Xu Yao Hen Kuai Shuo Wan", # ~20 chars
 ...
 {
 "character": "Alice",
 "content": "Tai Kai Xin Le!Wo Hao Gao Xing!",
 },
 ]
 result = agent_with_voices.create_render_plan(dialogues)
 ...
 {
 "character": "Alice",
 "content": "Ni Hao, Hen Gao Xing Ren Shi you",
 "start_time_ms": 0,
 "duration_ms": 1500,
 },
 {
 "character": "Bob",
 "content": "Ni Hao, Wo Ye Hen Gao Xing",
 "start_time_ms": 1800,
 "duration_ms": 1200,
 },
 {
 "character": "Alice",
 "content": "Na Wo Men start Ba",
 "start_time_ms": 3200,
 "duration_ms": 1000,
 },
 ]
