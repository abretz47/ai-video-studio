        ...
        return SimpleNamespace(
            ...
            data={
                "dialogues": [
                    ...
                    {"scene_number": 1, "character": "A", "content": "Wo Men continue Wang Qian。"},
                    {"scene_number": 2, "character": "B", "content": "not Ying Gai Chu Xian"},
                ],
                "stage_directions": [
                    {
                        "scene_number": 1,
...
async def test_try_fill_pending_scenes_after_react_returns_none_when_constraints_not_met():
    ...
    async def _generate_text(**_: object):
        ...
        return SimpleNamespace(
            ...
            data={
                "dialogues": [
                    {"scene_number": 1, "character": "A", "content": "Tai Duan"},
                    {"scene_number": 1, "character": "B", "content": "Reng Ran Duan"},
                ],
                "stage_directions": [],
            },
        )
