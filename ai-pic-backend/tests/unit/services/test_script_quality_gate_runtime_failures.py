...
async def test_script_gate_auto_creates_episode_temporary_speaker(
    ...
    content["scenes"][0]["characters"] = ["Lin Xue", "courier Yuan"]
    content["dialogues"].append(
        {"scene_number": 1, "character": "courier Yuan", "content": "don't move！"}
    )
    ...
    async def fake_auto_create_episode_characters(
        **kwargs: Any,
        ...
        assert kwargs["unknown_names"] == ["courier Yuan"]
        ...
        return [{"episode_character_id": 123, "character_name": "courier Yuan"}]
            ...
            "character_validation_results": [
                {
                    ...
                    "details": {"unknown_speakers": ["courier Yuan"]},
                }
            ],
            "character_warnings": ["Unknown speaker(s) in dialogues: courier Yuan"],
    ...
    assert result["auto_created_characters"] == [
        {"episode_character_id": 123, "character_name": "courier Yuan"}
    ]
    assert updated_content["dialogues"][-1]["character"] == "courier Yuan"
