...
def test_stub_episode_from_outline_builds_scenes_and_plot_points_from_beats():
 ...
 "act_label": "ACT1",
 "beat_title": "opening",
 "beat_summary": "Zhu Jue Chu Chang",
 "location_hint": "cafe",
 },
 {
 "act_label": "ACT2",
 ...
 assert result["plot_points"][0]["description"] == "Zhu Jue Chu Chang"
...
def test_stub_episode_from_outline_without_beats_builds_multi_scene_fallback():
 ...
 {"episode_number": 1, "title": "Test", "logline": "Protagonist discover key evidence."}
)
