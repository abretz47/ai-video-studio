...
def test_stub_episode_from_outline_builds_scenes_and_plot_points_from_beats():
        ...
        "beats": [
            {
                "act_label": "ACT1",
                "beat_title": "opening",
                "beat_summary": "protagonist Chu Chang",
                "location_hint": "cafe",
            },
            {
                "act_label": "ACT2",
                "beat_title": "conflict",
                "description": "Fa Sheng Chong Tu",
            },
        ],
    }
    ...
    assert result["plot_points"][0]["description"] == "protagonist Chu Chang"
    assert result["plot_points"][0]["timing"] == "ACT1 - opening"
...
def test_stub_episode_from_outline_without_beats_builds_multi_scene_fallback():
    result = stub_episode_from_outline(
        {"episode_number": 1, "title": "Test", "logline": "protagonist discover key Zheng Ju。"}
    )
