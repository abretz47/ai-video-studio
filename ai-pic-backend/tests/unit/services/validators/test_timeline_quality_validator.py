...
class TestTimelineQualityValidator:
    ...
    def test_calculate_average_wps(
        ...
        beats = [
            {
                "beat_type": "dialogue",
                "text": "Zhe Shi Shi Ge Zi test",  # 8 chars
                "start_ms": 0,
    ...
    def test_analyze_emotion_curve(
        ...
        beats = [
            {"start_ms": 0, "text": "calm start", "emotion": "calm"},
            {"start_ms": 1000, "text": "tense Qi Lai", "emotion": "tense"},
            {"start_ms": 2000, "text": "climax Bao Fa！crisis！", "emotion": "angry"},
            {"start_ms": 3000, "text": "calm Jie Shu", "emotion": "calm"},
        ]
    ...
    def test_check_dramatic_pauses_missing(
        ...
        beats = [
            ...
            {"beat_type": "dialogue", "text": "continue Shuo", "start_ms": 1000, "end_ms": 2000},
        ]
    ...
    def test_check_dramatic_pauses_present(
        ...
        beats = [
            ...
            {"beat_type": "dialogue", "text": "continue Shuo", "start_ms": 1800, "end_ms": 2800},
        ]
        issues = validator._check_dramatic_pauses(beats)
        missing_issues = [
            i for i in issues
    ...
    def test_estimate_duration_syllable_level_chinese(
        ...
        text = "Zhe Shi Yi Duan test Wen Ben，Yong Yu validate when Zhang Gu Suan。"
