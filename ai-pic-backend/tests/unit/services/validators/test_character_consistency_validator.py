...
Jane Roe: is A，Wo Men Qu San Bu Ba。
Wang Mei: Hao Zhu Yi！
"""
...
"""
    ...
    def test_validate_names_in_text_unknown_character(self, validator):
        ...
        text = """
John Doe: Ni Hao。
Stranger: Ni Hao，Wo is Stranger。
"""
        results = validator.validate_names_in_text(text)
...
"""
    ...
    def test_validate_names_skip_narrator(self, validator):
        ...
        text = """
voiceover: Zhe Shi Yi Ge Yang Guang Ming Mei Zao Chen。
...
Dr. Lin：Ni Jin Tian Gan Jue Zen Me Yang？
"""
        results = validator.validate_names_in_text(text)
    ...
    def test_unknown_character_in_dialogue(self, validator):
        ...
        text = """
Dr. Lin：Ni Hao。
mysterious Ren：Wo have Zhong Yao Shi Gao Su Ni。
Xiao Ming：Na is who？
"""
        results = validator.validate_names_in_text(text)
        ...
        warnings = [r for r in results if r.severity == ValidationSeverity.WARNING]
        assert len(warnings) >= 1
        assert any("mysterious Ren" in str(r.details) for r in warnings)

    def test_multiple_unknown_characters(self, validator):
        """Test detecting multiple unknown characters."""
        text = """
Passerby A：Ni Kan Jian Ma？
passerby Yi：is，Tai Jing Ren。
...
"""
    ...
    def test_narrator_not_flagged(self, validator):
        ...
        text = """
voiceover: Zhe Shi Yi Ge Qing Lang Zao Chen。
Narrator: The story begins here.
Hua Wai Yin: Yuan Chu Chuan Lai Sheng Yin。
