...
class TestInfoGateValidator:
 ...
 info_content="Jane Roe Shi undercover Jing Cha",
 ...
 info_content="Xiong Qi Shi Yi Ba Bi Shou",
 ...
 keywords = validator._extract_keywords("Jane Roe Shi undercover Jing Cha")
 ...
 assert "Wo Di Jing" in keywords # tri-gram
 ...
 speaker="John Doe",
 dialogue_text="Wo Zhi Dao Jane Roe Shi undercover Jing Cha",
 context=context,
)
 ...
 dialogue_text="Jane Roe Shi undercover Jing Cha",
 context=context,
)
 assert len(violations) > 0
 ...
 violations = validator.validate_dialogue(
 speaker="Passerby A",
 dialogue_text="Wo Ting Shuo Jane Roe Shi undercover", # "undercover" matches info keywords
 context=context,
)
 # "undercover" keyword matches "Jane Roe Shi undercover Jing Cha"
 assert len(violations) > 0
 ...
 violations = validator.validate_dialogue(
 speaker="Passerby A",
 dialogue_text="Tian Hai Ji Tuan Shi Yi Jia Da company",
 context=context,
)
 ...
 "scene_number": 2,
 "dialogues": [
 {"speaker": "passerby", "text": "Ting Shuo Jane Roe Shi undercover Jing Cha"}, # Violation!
 ],
 },
 ]
 }
