...
class TestDurationQualityValidator:
    ...
    def test_analyze_word_distribution_basic(
        ...
        scenes = [
            {"dialogues": [{"content": "Zhe Shi Di Yi Chang dialogue"}]},  # 8 chars
    ...
    def test_analyze_word_distribution_front_heavy(
        ...
        scenes = [
            {"dialogues": [{"content": "Zhe Shi Hen Zhang Hen Zhang Hen Zhang Di Yi Chang dialogue content！"}]},  # 16 chars
            {"dialogues": [{"content": "Di Er Chang Ye Hen Zhang Hen Zhang Hen Zhang dialogue！"}]},  # 14 chars
    ...
    def test_analyze_word_distribution_back_heavy(
        ...
        scenes = [
            {"dialogues": [{"content": "Duan"}]},  # 1 char
            {"dialogues": [{"content": "Duan Duan"}]},  # 2 chars
            {"dialogues": [{"content": "Zhe Shi Hen Zhang Hen Zhang Hen Zhang Di San Chang dialogue content！"}]},  # 16 chars
            {"dialogues": [{"content": "Di Si Chang Ye Hen Zhang Hen Zhang Hen Zhang dialogue！"}]},  # 14 chars
        ]
        analysis = validator.analyze_word_distribution(scenes, "zh")
    ...
    def test_check_word_distribution_issues(
        ...
        # Front-heavy scenes
        scenes = [
            {"dialogues": [{"content": "Zhe Shi Fei Chang Fei Chang Fei Chang Zhang Di Yi Chang dialogue content！"}]},
            {"dialogues": [{"content": "Di Er Chang Ye is Fei Chang Fei Chang Zhang dialogue！"}]},
    ...
    def test_validate_with_issues(
        ...
        scenes = [
            {"dialogues": [{"content": "Zhe Shi Fei Chang Fei Chang Zhang Di Yi Chang dialogue content！！！"}]},
            {"dialogues": [{"content": "Duan"}]},
        ]
