...
class TestDurationQualityValidator:
 ...
 text = "Zhe Shi Yi Duan test Wen Ben" # 8 characters
 ...
 scenes = [
 {"dialogues": [{"content": "Zhe Shi Di Yi Chang De dialogue"}]}, # 8 chars
 {"dialogues": [{"content": "Di Er Chang dialogue content"}]}, # 7 chars
 {"dialogues": [{"content": "Di San Chang"}]}, # 3 chars
 {"dialogues": [{"content": "Di Si Chang Jie Wei dialogue"}]}, # 7 chars
 ]
 ...
 scenes = [
 {"dialogues": [{"content": "Zhe Shi Hen Zhang Hen Zhang Hen Zhang De Di Yi Chang dialogue content!"}]}, # 16 chars
 {"dialogues": [{"content": "Di Er Chang Ye Hen Zhang Hen Zhang Hen Zhang De dialogue!"}]}, # 14 chars
 {"dialogues": [{"content": "Duan"}]}, # 1 char
 {"dialogues": [{"content": "Duan Duan"}]}, # 2 chars
 ]
 analysis = validator.analyze_word_distribution(scenes, "zh")
 ...
 {"dialogues": [{"content": "Duan"}]}, # 1 char
 {"dialogues": [{"content": "Duan Duan"}]}, # 2 chars
 {"dialogues": [{"content": "Zhe Shi Hen Zhang Hen Zhang Hen Zhang De Di San Chang dialogue content!"}]}, # 16 chars
 {"dialogues": [{"content": "Di Si Chang Ye Hen Zhang Hen Zhang Hen Zhang De dialogue!"}]}, # 14 chars
 ]
 analysis = validator.analyze_word_distribution(scenes, "zh")
 ...
 scenes = [
 {"dialogues": [{"content": "Zhe Shi Di Yi Chang dialogue"}]},
 {"dialogues": [{"content": "Zhe Shi Di Er Chang dialogue"}]},
 {"dialogues": [{"content": "Zhe Shi Di San Chang dialogue"}]},
 {"dialogues": [{"content": "Zhe Shi Di Si Chang dialogue"}]},
 ]
 analysis = validator.analyze_word_distribution(scenes, "zh")
 ...
 # Front-heavy scenes
 scenes = [
 {"dialogues": [{"content": "Zhe Shi Fei Chang Fei Chang Fei Chang length De Di Yi Chang dialogue content!"}]},
 {"dialogues": [{"content": "Di Er Chang Ye Shi Fei Chang Fei Chang length De dialogue!"}]},
 {"dialogues": [{"content": "Duan"}]},
 {"dialogues": [{"content": "Duan"}]},
 ]
 ...
 scenes = [
 {"dialogues": [{"content": "scene Yi dialogue"}]},
 {"dialogues": [{"content": "scene Er dialogue"}]},
 {"dialogues": [{"content": "scene San dialogue"}]},
 ]
 scene_budgets = [
 ...
 scenes = [
 {"dialogues": [{"content": "Zhe Shi Fei Chang Fei Chang length De Di Yi Chang dialogue content!!!"}]},
 {"dialogues": [{"content": "Duan"}]},
 ]
