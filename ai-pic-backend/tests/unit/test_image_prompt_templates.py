...
def test_environment_image_prompt_template_renders_constraints():
    prompt = prompt_manager.render_prompt(
        "environment_image",
        {
            ...
            "description": "Xuan Fu screen、Bo Li Ge Duan、Leng Se Diao Deng Guang",
            "prompt": "Leng Se Diao science fiction office，Bo Li Ge Duan and Xuan Fu screen",
...
def test_environment_image_variant_prompt_template_renders_instructions():
    prompt = prompt_manager.render_prompt(
        "environment_image_variant",
        {
            ...
            "tags": "science fiction, office, future",
            "description": "Xuan Fu screen、Bo Li Ge Duan、Leng Se Diao Deng Guang",
            "base_prompt": "Leng Se Diao science fiction office，Bo Li Ge Duan and Xuan Fu screen",
            "variant_prompt": "Gai Wei Ye Jing，Zeng Jia Bo Li Fan She and Geng Qiang Dui Bi Du Deng Guang",
        },
    )
...
def test_storyboard_image_prompt_template_includes_quality_and_constraints():
    prompt = prompt_manager.render_prompt(
        ...
        {
            "base_prompt": "Ye Se in Cang Ku，Jing Bie: medium shot",
