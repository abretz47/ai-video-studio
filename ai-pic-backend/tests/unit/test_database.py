"""
test database configuration and Gong Ju
"""
...
class TestDatabase:
    ...
    def __init__(self, use_memory: bool = True):
        ...
        self.engine = create_engine(
            ...
            echo=False,  # set forTrueKe Yi Kan DaoSQLYu Ju
        )

        # Que Bao Suo You model be Jia Zai Yi Zhu Ce to Base.metadata
...
def get_test_db() -> Generator[Session, None, None]:
    """get test database Hui Hua Yi Lai Zhu Ru Han Shu"""
