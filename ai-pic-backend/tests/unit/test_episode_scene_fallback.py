...
def test_ensure_scenes_filters_empty_scene_objects():
    ep_data = {
        "summary": "S",
        "plot_points": [
            {"description": "d1", "timing": "opening"},
            {"description": "d2", "timing": "Zhong Duan"},
            {"description": "d3", "timing": "Jie Wei"},
        ],
        "scene_count": 6,
        "scenes": [{}, {}, {}, {}, {}, {}],
    }
...
def test_ensure_scenes_expands_underreported_scene_count_from_plot_points():
    ep_data = {
        "summary": "S",
        "plot_points": [
            {"description": "hook", "timing": "opening"},
            {"description": "escalate", "timing": "Zhong Duan"},
            {"description": "payoff", "timing": "after Duan"},
            {"description": "cliffhanger", "timing": "Jie Wei"},
        ],
        "scene_count": 1,
        "scenes": [
            {
