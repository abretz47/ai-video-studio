...
class TestSettings(BaseSettings):
    ...
    PROJECT_NAME: str = "AITu Pian generateAPI - Ce Shi Huan Jing"
    VERSION: str = "1.0.0"
    ...
    # Nei Cun database（Geng Kuai test）
    MEMORY_DATABASE_URL: str = "sqlite:///:memory:"

    # Redisconfiguration（test Yong）
    REDIS_URL: str = "redis://localhost:6379/1"  # use Bu Tong database
    ...
    # You Jian configuration（test Yong）
