...
def test_style_schema_options_use_chinese_labels():
 ...
 assert style_universe_labels["japanese_anime"] == "Ri Xi Dong Man"
...
def test_style_presets_expose_chinese_labels_and_descriptions():
 ...
 assert cyberpunk.label == "Sai Bo Peng Ke·Ni Hong"
 assert cyberpunk.description and "Sai Bo" in cyberpunk.description
