...
class TestResolveCharacterResources:
    ...
    def test_resolve_with_no_overrides(self):
        ...
        virtual_ip.style_prompt = "wearing Zhi Fu"
        ...
        character.character_name = "courier Yuan"
        ...
        assert result["appearance_prompt"] == "wearing Zhi Fu"
        assert result["display_name"] == "courier Yuan"
    ...
    def test_resolve_with_missing_virtual_ip(self):
        ...
        character.character_name = "Wei Zhi character"
        ...
        assert result["display_name"] == "Wei Zhi character"
...
class TestGetCharacterDisplayName:
    ...
    def test_display_name_from_virtual_ip(self):
        ...
        assert result == "general-purpose character"
    ...
    def test_display_name_fallback(self):
        ...
        assert result == "temporary character10"
