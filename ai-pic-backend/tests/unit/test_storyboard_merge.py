...
def test_merge_frames_preserves_other_scenes():
 ...
 new_raw = [
 {"scene_number": 2, "description": "new frame A", "shot_type": "medium shot"},
 {"scene_number": 2, "description": "new frame B", "shot_type": "close shot"},
 ]
 scene_map = {1: {}, 2: {}}
...
def test_enforce_storyboard_variety_changes_duplicates():
 ...
 {
 "scene_number": 1,
 "description": "Jue Se Dui Hua",
 "shot_type": "medium shot",
 "camera_movement": "fixed",
 "composition": "rule of thirds",
 "duration_seconds": 3,
 "ai_prompt": "Jue Se Dui Hua",
 },
 {
 "scene_number": 1,
 "description": "Jue Se Dui Hua",
 ...
 assert diversified[0]["shot_type"] == "medium shot"
 assert diversified[1]["shot_type"]!= diversified[0]["shot_type"]
 assert "Bian Ti" in diversified[1]["description"]
