...
class TestVirtualIPAPI:
    ...
    def test_generate_virtual_ip_image_variant(
        ...
        """test based on Yi You virtualIPimage generate Bian Ti（Tu Sheng image）"""
        setup_factories(db_session)

        virtual_ip = VirtualIPFactory()

        # Shou Dong create Yi Tiao Ji Chu image record，Bi Mian Yi Lai Guo Shi Gong Chang Zi Duan
        ...
        payload = {
            "prompt": "for Dang Qian character generate Bu Tong Shi Jiao/Zi Tai image，Ru back view Zhao or full-body shot",
            "model": "google:gemini-3-pro-image-preview",
            "count": 1,
            "reference_images": ["/uploads/ref_test.png"],
        }

        # Wei Ben Ce Shi Yong Li Zhu Ru Zui Xiao ai_service mock，Bi Mian Zhen Shi Wai Bu call
        ...
        # Ru Guo failed，in Duan Yan Xiao Xi in Dai Shang response content Bian Yu Tiao Shi
...
class TestStoryAPI:
    ...
    def test_generate_story_outline(
        ...
        # LangGraph / Guan Li Qi Ke Neng Bu Tong Shi Xian，Zhe Li Jin Jiao Yan Zi Duan exists and method Biao Ji
...
class TestAPIValidation:
    ...
    def test_create_virtual_ip_validation(
        ...
        """test virtualIPcreate validate"""
        # test Que Shao Bi Xu Zi Duan
        data = {
    ...
    def test_create_story_validation(self, client: TestClient, db_session: Session):
        ...
        data = {
            "title": "Test Story",
            "genre": "Romance",
            "duration_minutes": "invalid",  # Ying Gai is Zheng Shu
        }
    ...
    def test_search_filtering(self, client: TestClient, db_session: Session):
        """test Sou Suo and Guo Lv"""
        setup_factories(db_session)

        # create Te Ding name virtualIP
...
class TestAPIErrorHandling:
    ...
    def test_500_error_handling(self, client: TestClient, db_session: Session, mocker):
        ...
        # Yin Ci Zhe Li Duan Yan exception be Pao Chu Ji Ke。
...
class TestEndToEndWorkflow:
    ...
    def test_complete_story_creation_workflow(
        ...
        """test complete story create work Liu"""
        setup_factories(db_session)
