...
class TestVirtualIPAPI:
 ...
 """test based on Yi You virtualIPimage generate Bian Ti(Tu Sheng Tu)"""
 setup_factories(db_session)

 virtual_ip = VirtualIPFactory()

 # Shou Dong create Yi Tiao basic image record, Bi Mian Yi Lai Guo Shi De Gong Chang character Duan
 ...
 payload = {
 "prompt": "Wei Dang Qian character generate Bu Tong Shi Jiao/Zi Tai De image, Ru back view Zhao Huo Quan Shen Zhao",
 "model": "google:gemini-3-pro-image-preview",
 "count": 1,
 "reference_images": ["/uploads/ref_test.png"],
 }

 # Wei Ben Ce Shi Yong Li Zhu Ru Zui Xiao De ai_service mock, Bi Mian Zhen Shi Wai Bu call
 ...
 *,
 ...
 # Ru Guo Shi Bai, Zai Duan Yan Xiao Xi Zhong Dai Shang response content Bian Yu Tiao Shi
...
class TestStoryAPI:
 ...
 # LangGraph / Guan Li Qi possible Bu Tong Shi Xian, Zhe Li Jin Jiao Yan character Duan exists Yu method Biao Ji
...
class TestAPIValidation:
 ...
 """Ce Shi Xu NiIPChuang Jian Yan Zheng"""
 # test Que Shao Bi Xu character Duan
 data = {
 ...
 """test story create validate"""
 # test Wu Xiao De type
 data = {
 "title": "Test Story",
 "genre": "Romance",
 "duration_minutes": "invalid", # Ying Gai Shi Zheng Shu
 }
 ...
 """test Sou Suo He Guo Lv"""
 setup_factories(db_session)

 # create Te Ding name De virtualIP
...
class TestAPIErrorHandling:
 ...
 # TestClient Mo Ren Hui re-raise server exceptions(raise_server_exceptions=True)
 # Yin Ci Zhe Li Duan Yan exception Bei Pao Chu Ji Ke.
 ...
 data = {
 "name": "", # Kong Zi Fu Chuan
 "description": "A" * 1000, # Tai Zhang
 "tags": "not_a_list", # Cuo Wu Lei Xing
 }
...
class TestEndToEndWorkflow:
 """Duan Dao Duan work Liu test"""

 def test_complete_story_creation_workflow(
 self, client: TestClient, db_session: Session, mock_ai_service
):
 """test complete De story create work Liu"""
 setup_factories(db_session)

 # 1. Chuang Jian Xu NiIP
 vip_data = {
 "name": "Test Character",
