                ...
                "clips": [
                    {
                        ...
                        "end_ms": 4000,
                        "duration_ms": 4000,
                        "text": "robot check Shi Jian Zhou on Di Yi Ke Guang Dian。",
                        "placeholder": True,
                        "asset_ref": None,
                        "source": {
                            "kind": "audio_timeline_beat",
    ...
    return [
        {
            "clip_id": "video_scene_001_beat_001_001",
            "duration_ms": 4000,
            "plot": "robot check Shi Jian Zhou on Di Yi Ke Guang Dian。",
            ...
            "direction_anchor": "Chao Xiang lonely Qing Dao Fu discover Xian Suo Leng You Mo camera",
