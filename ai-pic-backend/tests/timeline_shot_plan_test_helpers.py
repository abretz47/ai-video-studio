...
def _bootstrap_episode(db: Session) -> tuple[Episode, Script]:
 ...
 content="robot: time Xian Xian Zou.",
...
def _timeline_spec(episode: Episode, script: Script) -> dict:
 ...
 "end_ms": 4000,
 "duration_ms": 4000,
 "text": "robot check Shi Jian Zhou Shang De Di Yi Ke Guang Dian.",
 "placeholder": True,
 "asset_ref": None,
 "source": {
 "kind": "audio_timeline_beat",
...
def _valid_shots() -> list[dict]:
 ...
 "clip_id": "video_scene_001_beat_001_001",
 "duration_ms": 4000,
 "plot": "robot check Shi Jian Zhou Shang De Di Yi Ke Guang Dian.",
 "dialogue_source": "robot: time Xian Xian Zou.",
 ...
 "robot: time Xian Xian Zou., clear camera push-in, 4 seconds"
),
 "character_anchor": "non-real blue robot with LED eyes",
 "camera": "slow push-in",
 "action": "points at the first glowing timeline bead",
 "direction_anchor": "Chao Xiang lonely Qing Dao Fu discover Xian Suo De Leng You Mo camera",
