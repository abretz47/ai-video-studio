...
def test_generate_script_syncs_normalized_scenes(
 ...
 {
 "scene_number": 1,
 "summary": "Tong Bu Gui Fan Hua scene test",
 "location": "Xiao Yuan",
 "time_of_day": "Bai Tian",
 },
 {"scene_number": 2, "summary": "Di Er Ge scene"},
 ]
 },
)

 # Qiang Zhi use Ben Di mock, Bi Mian Zhen Shi LLM call
 ...
 assert script_obj.scenes[0].get("summary") == "Tong Bu Gui Fan Hua scene test"
...
.all()
 ...
 # Zai Ci Sheng Cheng(regenerate)Bu Hui Chong Fu create Gui Fan Hua scene
