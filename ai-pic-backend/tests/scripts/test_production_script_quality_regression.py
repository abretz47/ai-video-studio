...
def test_repair_notes_include_script_score_and_structured_feedback() -> None:
 ...
 "risks": ["character Bian Shi Du Bu Zu: Tai Ci Ke Hu Huan"],
 "rewrite_guidance": ["Gei Protagonist fixed Kou Tou Chan, Bing Bu Qian Zhi Xian Suo"],
 },
 ...
 assert "character Bian Shi Du Bu Zu" in joined
 assert "Gei Protagonist fixed Kou Tou Chan" in joined
