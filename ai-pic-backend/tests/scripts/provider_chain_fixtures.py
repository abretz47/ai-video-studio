...
class CliffhangerManager:
 ...
 "evidence": "final Yi Ju Liu Xia evidence Yi Wen",
 "suggestion": "",
 },
)
...
def _scene_one() -> dict:
 ...
 "scene_id": "s1",
 "duration_seconds": 15,
 "question": "Shui Ba Xiao Lan De bonus countdown reset to zero?",
 ...
 "turn": "permission Ju Jue Hou, Ri Zhi Fan Xiang Tiao Chu Cao Zuo Zhe Bian Hao.",
 "plot": "Xiaolan discover bonus Bei reset to zero, Jing Bao Xiang Qi.",
 "dialogue": [{"speaker": "Xiaolan", "line": "Shui Qing Kong bonus"}],
 "beats": [
 _beat(
 1,
 "hook",
...
def _scene_two() -> dict:
 ...
 "scene_id": "s2",
 "duration_seconds": 15,
 "question": "Xiao Lan Neng Bu Neng Zai Ri Zhi delete Qian Na Dao evidence?",
 "stakes": "Ri Zhi delete Qian Na Bu Dao evidence, customer Yan Shou Hui failed.",
 "opposition": "Hei Ying Zai Hou Tai delete final Ri Zhi.",
 "turn": "bonus record Hui Fu Yi Ban Hou, Hei Ying delete final Ri Zhi.",
 "plot": "Xiaolan discover truth, final Yi Miao Fan Zhuan.",
 "dialogue": [{"speaker": "Xiaolan", "line": "evidence Zhi Xiang Hei Ying"}],
 "beats": [
 _beat(
 1,
 "conflict",
 ...
 **_beat(
 2,
 "payoff",
 "Zheng Ming Protagonist Zhao Dao key evidence",
 ...
 **_beat(
 3,
 "cliffhanger",
 "Liu Xia new De Cao Zuo Zhe Wei Xie",
...
def _video(clip_id: str, ordinal: int) -> dict:
 ...
 "dialogue_source": "Xiaolan: evidence Zai Zhe Li",
