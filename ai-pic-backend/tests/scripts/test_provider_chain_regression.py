...
def test_extract_structured_script_requires_dialogue() -> None:
    ...
    ```json
    {
      ...
      "logline": "robot in Ye Ban Zhao Hui Yi Shi Ding Dan。",
      "characters": [
        {
          "name": "Xiaolan",
          "role": "protagonist",
      ...
      "scenes": [
        {
          ...
          "stakes": "Ru Guo Xiaolan Zhua Bu Zhu Ding Dan，Ye Ban Jie Suan Ping Hui Li Ji Kou Diao Ta Wei Xiu Dian Chi。",
          "opposition": "Hui Fa Guang Ding Dan Piao Ju Duo Jin Huo Jia Feng Xi，Gu Yi Bi Kai Sao Ma Qi。",
          "turn": "Xiao Lan Yong Cheng Se Wei Jin Chan Zhu Piao Ju when，Piao Ju Liang Chu Ling Yi Zhang Wei Fu Kuan Ding Dan。",
          "plot": "Xiaolan discover Ding Dan Hui Zi Ji Yi Dong。",
          "dialogue": [{"speaker": "Xiaolan", "line": "Bie Pao，Wo Hai Mei Sao Ma。"}],
          "beats": [
            {
              "beat_type": "hook",
              "visible_event": "Shou Yin Tai on Lan Guang Ding Dan Piao Ju Tu Ran Dan Qi，Zhuang Fan Xiao Lan Shou Bian Sao Ma Qiang。"
            },
            {
              "beat_type": "turn",
            ...
            },
            {
              ...
              "visible_event": "Qian Kuan Dan Shang countdown Tiao to San Miao，Xiaolan Xiong Kou Wei Xiu Dian Chi start Shan Hong。"
            }
          ],
