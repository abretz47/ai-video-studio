...
def test_extract_structured_script_requires_dialogue() -> None:
 ...
 ```json
 {
 "title": "Ji Jia Bian Li Dian",
 "logline": "robot Zai Ye Ban Zhao Hui Yi Shi De Ding Dan.",
 "characters": [
 {
 "name": "Xiaolan",
 "role": "Protagonist",
 "appearance_prompt": "Yuan Run Lan Se robot",
 ...
 "scene_id": "s1",
 "duration_seconds": 4,
 "question": "Ding Dan why Hui Zi Ji Yi Dong?",
 "stakes": "Ru Guo Xiaolan Zhua Bu Zhu Ding Dan, Ye Ban Jie Suan Ping Hui Li Ji Kou Diao Ta De Wei Xiu Dian Chi.",
 "opposition": "Hui Fa Guang De Ding Dan Piao Ju Duo Jin Huo Jia Feng Xi, Gu Yi Bi Kai Sao Ma Qi.",
 "turn": "Xiao Lan Yong Cheng Se Wei Jin Chan Zhu Piao Ju Shi, Piao Ju Liang Chu Ling Yi Zhang not yet Fu Kuan Ding Dan.",
 "plot": "Xiaolan discover Ding Dan Hui Zi Ji Yi Dong.",
 "dialogue": [{"speaker": "Xiaolan", "line": "Bie Pao, Wo Hai Mei Sao Ma."}],
 "beats": [
 {
 "beat_type": "hook",
 "visible_event": "Shou Yin Tai Shang De Lan Guang Ding Dan Piao Ju suddenly Dan Qi, Zhuang Fan Xiao Lan Shou Bian De Sao Ma Qiang."
 },
 {
 "beat_type": "turn",
 "visible_event": "Xiao Lan Yong Cheng Se Wei Jin Tao Zhu Piao Ju, Piao Ju Que Tuo Chu Yi Zhang red Qian Kuan Dan."
 },
 {
 "beat_type": "cliffhanger",
 "visible_event": "Qian Kuan Dan Shang De countdown Tiao to San Miao, Xiaolan Xiong Kou De Wei Xiu Dian Chi start Shan Hong."
 }
 ],
 ...
 assert script["title"] == "Ji Jia Bian Li Dian"
 assert script["scenes"][0]["dialogue"][0]["line"] == "Bie Pao, Wo Hai Mei Sao Ma."
...
def test_timeline_seed_precedes_video_assets_and_preserves_lineage() -> None:
 ...
 "duration_seconds": 15,
 "plot": "robot Jin Men.",
 "dialogue": [{"speaker": "Xiaolan", "line": "I'm here."}],
 "video_prompt": "robot enters",
 },
 {
 "scene_id": "s2",
 "duration_seconds": 15,
 "plot": "robot Jie Jue Wen Ti.",
 "dialogue": [{"speaker": "Xiaolan", "line": "Ding Dan Gui Wei."}],
 ...
 assert seed_dialogue_clips[0]["text"] == "Xiaolan: I'm here."
 assert seed_subtitle_clips[0]["text"] == "Xiaolan: I'm here."
 ...
 assert seed_video_clips[0]["source_refs"]["plot"] == "robot Jin Men."
 assert (
 ...
 assert video_clips[0]["source_refs"]["dialogue"][0]["line"] == "I'm here."
