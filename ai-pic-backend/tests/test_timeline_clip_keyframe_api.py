...
def test_timeline_clip_keyframes_creates_generation_task_for_selected_clip(
    ...
    video_clip["source_refs"] = {
        "timeline_shot_plan": {
            ...
            "motion_timeline": [
                ...
                {"at_ms": 1200, "action": "Ta Tai Yan Kan Xiang Yu in Che Chuang"},
            ],
    ...
    assert "Ta Di Tou Ding phone screen" in params["frames"][0]["prompt"]
    assert "Ta Tai Yan Kan Xiang Yu in Che Chuang" in params["frames"][1]["prompt"]
