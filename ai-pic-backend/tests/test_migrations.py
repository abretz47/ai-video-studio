...
class TestMigrations:
    ...
    def test_migration_creates_correct_columns(self):
        """test migration create correct Lie"""
        # run migration
        command.upgrade(self.alembic_cfg, "head")
    ...
    def test_migration_creates_foreign_keys(self):
        ...
        # check virtualIPimage Biao Wai Jian
    ...
    def test_migration_sqlite_compatibility(self):
        """test migration andSQLiteJian Rong Xing"""
        # run migration
        command.upgrade(self.alembic_cfg, "head")

        # test Ji BenCRUDoperation
    ...
    def test_migration_downgrade(self):
        ...
        # Jian Cha Biao be delete
        inspector = inspect(self.engine)
        tables_after = inspector.get_table_names()

        # only Ying Gai Sheng Xiaalembic_versionBiao
