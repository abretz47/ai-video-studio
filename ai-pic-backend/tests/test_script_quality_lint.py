...
class _CliffhangerManager:
 ...
 "passed": self.passed,
 "score": self.score,
 "reason": "Jie Wei Zhi Zao Le continue Kan De issue" if self.passed else "Jie Wei Shou Shu",
 "evidence": "Zui Hou San Xing",
 "suggestion": "Bu Yi Ge new issue",
 },
)
...
Xiao Ming: Wo Zhen De Fei Chang Fei Chang Fei Chang Sheng Qi you why Zhe Yang Zuo
Ni Hao.
Jie Shu Le.
"""
 result = await lint_script_content_async(
...
▲【sound effect】Peng!Dian Men Bei Zhuang Kai, Zhu Huo Meng Di Yi Huang.
Lin Xue(Leng Xiao): you Cang De ledger, Wo Zhao Dao Le.
Chen Mo(Hou Tui): you Bu Gai Peng it!
▲Lin Xue Ba ledger Shuai Dao An Shang, red Zhi Yin Lu Chu.
Lin Xue(Bi Jin): Na Jiu Gao Su Wo, Shui Qian De Zi?
Chen Mo(Ya Di Sheng): you Zhen Xiang Zhi Dao?
...
▲Wen Wen Ba phone Zhuan Xiang Old Guai, Zhong Duan Guang Zhao Zai Liang Ren Lian Shang.
Wen Wen(calm): don't move.
Old Guai(Huang Luan): you Zuo Le Shen Me?
▲Wen Wen Zhi Jian Xuan Zai Hui Che Jian Shang.
Wen Wen(Wei Xie): Shi Miao Hou Xiao Hui.
Old Guai(Shi Kong): Ni Feng Le!
...
Ren Wu: AP, Chen Mo
▲Tou Ying Shu Zi Bian Hong, customer Shou Zhi Chong Chong Qiao Zai error data Shang.
AP(calm): Zheng Ju Zai Zhe.
Chen Mo(Huang Luan): Wo Bu Zhi Dao.
▲APBa phone Ju Dao camera Qian, Duan Xin countdown from30Miao Tiao Dao29seconds.
▲【close-up】camera Ting Zai key Xian Suo Shang, Suo You Sheng Yin suddenly Ya Di.
AP(Ya Di Sheng): Ni Zhen Yi Wei, Zhe Jiu Shi Quan Bu truth?
"""
