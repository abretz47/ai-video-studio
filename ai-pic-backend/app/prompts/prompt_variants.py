...
def get_template_for_format(
 ...
 'story_outline_short_drama'
 >>> get_template_for_format("story_outline", micro_genre="Shu Ping Duan Ju")
 'story_outline_short_drama'
 """
 ...
 if any(kw in micro_lower for kw in ["short drama", "short", "Shu Ping"]):
 format_type = StoryFormat.SHORT_DRAMA
 elif any(kw in micro_lower for kw in ["film", "film", "movie"]):
 format_type = StoryFormat.FILM
 elif any(kw in micro_lower for kw in ["Dian Shi", "episode", "series"]):
