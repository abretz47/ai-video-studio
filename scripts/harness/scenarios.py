...
BROWSER_SCENARIOS: dict[str, BrowserScenario] = {
    ...
    "test_auth_smoke": BrowserScenario(
        ...
        path="/test-auth",
        requires_auth=False,
        required_text="Auth Diagnostics",
    ...
    "environment_asset_smoke": BrowserScenario(
        ...
        path="/environments",
        requires_auth=True,
        required_text="Environment Assets",
    ...
    "environment_detail_smoke": BrowserScenario(
        ...
        requires_auth=True,
        required_text="Environment Details",
    ...
    "workbench_smoke": BrowserScenario(
        ...
        path="/",
        requires_auth=True,
        required_text="Production Workbench",
    ...
    "episode_script_generation_form_smoke": BrowserScenario(
        ...
        requires_auth=True,
        required_text="Regenerate Script",
