    ...
    <div className="flex flex-wrap items-end gap-2">
      <label className="min-w-40">
        ...
        <input
          ...
          value={runId}
          placeholder={t("canvas.runControls.placeholder", "Auto-filled after creation")}
      ...
      <button
        ...
        onClick={onSave}
      >
        {t("canvas.runControls.save", "Save Canvas")}
      </button>
      <button
        type="button"
        ...
        onClick={onRestore}
      >
        {t("canvas.runControls.restore", "Restore Canvas")}
      </button>
      {status ? (
