...
export function TimelineClipGenerationChain({
  ...
  const steps: ChainStep[] = [
    {
      label: "Select References / Bindings",
      state: "ready",
      detail: "IP, environment, and manual references will be submitted with the task",
    },
    {
      label: "Images: Storyboard Frames",
  ...
  return (
    <section
      aria-label="Clip image/video generation flow"
