    ...
    <ClipProductionActionShell kind="storyboard" step="1" title="Clip storyboard">
      ...
      >
        ...
        <CompactProductionDetails
          label="..."
          ariaLabel="Expand storyboard settings and references"
          align="left"
          attached
        >
          <div className={FIELD_GRID_CLASS}>
            <label className="grid gap-1 text-xs text-gray-700">
              ...
              >
                <option value="live_action">Live-action film</option>
...
function StoryboardImageModelSelect({
  ...
  return (
    <label className="grid gap-1 text-xs text-gray-700">
      ...
      <select
        aria-label="Storyboard image model"
        value={value}
