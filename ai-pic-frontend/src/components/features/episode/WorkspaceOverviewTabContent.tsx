...
export function WorkspaceOverviewTabContent({
  ...
  return (
    <div className="space-y-4">
      <OperatorPanel>
        ...
        <div className="space-y-4 p-4">
          <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
            ...
            <Metric label="Duration" value={`${episode.duration_minutes || "—"} min`} />
            <Metric label="Scene Count" value={`${sceneCount || "—"} scenes`} />
      ...
      <OperatorPanel>
        <OperatorSectionHeader title="Plot Points" subtitle="plot points / conflicts" />
      ...
      {Object.keys(characterArcs).length || episode.tags?.length ? (
        <OperatorPanel>
          <OperatorSectionHeader title="Characters & Tags" subtitle="character arcs, tags, and metadata" />
          <div className="space-y-4 p-4">
