...
export function ClipEnvironmentSection({
  ...
  const environmentSummary = selectedEnvironment
    ...
    : "Not set";
  const environmentActionLabel = environments.length ? "Change" : "Unavailable";
  ...
  const sceneLabel = scene
    ...
    : "No normalized scene matched. The current environment is only used as clip generation reference.";
