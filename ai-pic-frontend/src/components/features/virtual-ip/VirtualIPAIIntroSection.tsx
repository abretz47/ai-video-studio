  ...
  return (
    <div className="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="text-sm font-medium text-gray-950">AI assist area</div>
          <div className="text-xs text-gray-600 mt-1">
            Enter a character concept or short drama persona, and AI will generate an editable draft.
          </div>
        </div>
        <button
          type="button"
      ...
      <textarea
        ...
        rows={3}
        placeholder="Example: A 30-year-old Beijing internet product manager—outwardly polished but inwardly sensitive, with the catchphrase “Align first, then act.” Loves black trench coats and coffee; avoid melodramatic lines; keep the overall tone realistic."
