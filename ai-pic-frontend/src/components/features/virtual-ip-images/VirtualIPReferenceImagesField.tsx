      ...
      <div className="flex items-center justify-between gap-2">
        <div>
          ...
          <p className="text-xs text-gray-500">
            Only works for models that support reference_images and will be used for style/composition guidance)
            {typeof maxSelection === "number" && maxSelection > 0
              ? `; up to ${maxSelection} images(exceeding this automatically replaces the earliest selection)`
              : null}
          </p>
        </div>
