...
/**
 * Style configuration for hook types
 */
...
interface HookTagBadgeProps {
  ...
  intensity?: string;
  /** whether to show the full label (otherwise only show the icon) */
  showLabel?: boolean;
  /** click callback */
  onClick?: () => void;
 ...
 *
 * Used to display hook types on storyboard frames (hook/reversal/payoff/cliffhanger, etc.)
 */
