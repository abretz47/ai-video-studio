      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div>
          ...
          <p className="mt-1 text-[11px] text-slate-500">
            ...
            )?.description || "Selecting a target market will automatically enable localization guidance."}
          </p>
        </div>
        <div>
          <label className="block text-xs font-medium text-slate-600 mb-1">
          ...
          <input
            ...
            placeholder="e.g. Mafia revenge / Fated werewolf mate"
            className="w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm"
          />
          ...
          <p className="mt-1 text-[11px] text-slate-500">
            Choose or enter a more specific genre tag.
          </p>
        </div>
        <div>
          <label className="block text-xs font-medium text-slate-600 mb-1">
          ...
          <p className="mt-1 text-[11px] text-slate-500">
            Automatically fills the hook plan, twist density, and ad creative suggestions.
          </p>
        </div>
      </div>
      <div className="rounded-md border border-dashed border-slate-200 bg-white p-3 text-xs text-slate-600">
        {selectedTemplate ? (
          ...
          <div className="text-slate-500">
            Choose a pacing template to see its pacing and hook notes.
          </div>
        )}
      </div>
    </div>
