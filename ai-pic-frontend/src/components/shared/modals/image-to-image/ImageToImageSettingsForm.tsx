...
export function ImageToImageSettingsForm({
  ...
  const modelHelperText =
    genMode === "image_to_image"
      ? "Only show models that support reference-image image-to-image (unsupported models are hidden)"
      : "Only show models that support reference-image text-to-image (unsupported models are hidden)";
      ...
      <div className="space-y-3">
        <div>
          ...
          <textarea
            ...
            placeholder="Describe the desired variant, such as back view, full body, or different lighting"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <p className="mt-1 text-[11px] text-gray-500">
              Up to {maxCount} images; some models may return multiple candidates.
            </p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
